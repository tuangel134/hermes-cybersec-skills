---
name: cybersec-attack-c2-lab
description: Selecciona herramientas C2/canales de comando del toolkit. Úsalo en laboratorios red team autorizados con Sliver, Empire, Caldera, Villain, Hoaxshell, pwncat-cs, BeEF y PentAGI.
---

# C2 and Command Channel Lab Selection
...
- sliver-server, sliver-client, empire, Caldera, Villain, Hoaxshell
- pwncat-cs, beef, pentagi, pentagi-docker
