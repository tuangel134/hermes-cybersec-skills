---
name: cybersec-attack-password-lab
description: Selecciona herramientas de cracking y password audit del toolkit. Úsalo en labs autorizados de hashes, wordlists, reglas, fuerza bruta controlada y recuperación de credenciales propias.
---

# Password and Hash Attack Lab Selection
...
- hashid, trevorspray, patator, DefaultCreds-cheat-sheet, Hob0Rules, OneRuleToRuleThemStill
- duplicut
