---
name: cybersec-profile-pwn
description: Usa el perfil pwn de cybersec-toolkit. Úsalo cuando el usuario pida preparar un entorno pwn con módulos: misc, pwn, reversing, crypto.
---

# CyberSec Profile pwn
...
```bash
cd cybersec-toolkit
sudo ./install.sh --dry-run --profile pwn
sudo ./install.sh --profile pwn
sudo ./scripts/verify.sh --profile pwn --skip-heavy
```
