---
name: cybersec-profile-wireless
description: Usa el perfil wireless de cybersec-toolkit. Úsalo cuando el usuario pida preparar un entorno wireless con módulos: misc, wireless, networking.
---

# CyberSec Profile wireless

Perfil upstream: `wireless`
...
```bash
cd cybersec-toolkit
sudo ./install.sh --dry-run --profile wireless
sudo ./install.sh --profile wireless
sudo ./scripts/verify.sh --profile wireless --skip-heavy
```
...
Input: "Prepara laboratorio wireless"  
